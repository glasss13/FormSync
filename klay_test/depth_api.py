...
result = client.predict(
		input_video={"video":handle_file('klay_vid.mp4')},
		max_len=500,
		target_fps=15,
		max_res=1280,
...
np.save("klay_depth.npy", grey_frames[12])
np.save("klay_depth_color.npy", frames[12])


frames = np.load("actual_video_frames.npy")
np.save("klay_actual.npy", frames[12])