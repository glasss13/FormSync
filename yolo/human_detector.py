...
def yolo_human_det(img, model, device, reso=416, confidence=0.70):
    inp_dim = reso
    num_classes = 80 # Standard COCO classes
    ...
    with torch.no_grad():
        ...
        output = write_results(output, confidence, num_classes, nms=True, det_hm=True)
